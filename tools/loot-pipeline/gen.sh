...
# LOOT STYLE — treasure CHEST / coin SACK, polished glossy anime/JRPG finish matching the gear + heroes. ONE closed item, fills square, NO shadow, rarity drives ornamentation.
STYLE="A single video-game LOOT icon — a treasure CHEST or a coin SACK — rendered in a POLISHED, appealing glossy ANIME / JRPG style that matches the game's gear and hero sprites: clean bold cel-shading with smooth gradients and crisp highlights, a clean defined dark outline, refined detailing and elegant metal / gold work, one warm light source from the TOP-LEFT, vibrant yet cohesive colours. THEME — clean HEROIC HIGH-FANTASY loot. COMPOSITION — a PERFECTLY SQUARE 1:1 image of the SINGLE closed item named in the subject, large and centered, filling about 86% of the frame at a natural GENTLE 3/4 view with only MILD perspective. The material and ornamentation MUST reflect its RARITY as the subject specifies — humble plain wood / burlap at low rarity, iron or steel reinforcement at mid rarity, ornate GOLD with gems, engraving and a subtle magical glow at high rarity. ABSOLUTELY NO shadow, NO ground, NO base, nothing beneath the item — just the ONE item. NO character, NO hands, NO scene. NO white sticker / die-cut border. NO text, name label, caption, signature, watermark or logo. Isolated on a solid FLAT PURE-WHITE background. Subject: "
